...
$$\\text{MSE}(w,b) = \\frac{1}{n}\\sum_{i=1}^{n}\\left(\\hat{y}_i - y_i\\right)^2$$
...
1. **Silhouette Score ($S \in [-1, 1]$):**[educative](https://www.educative.io/answers/what-is-silhouette-score)​youtube​  
...
2. **Davies-Bouldin Index (DBI):**youtube​[codesignal](https://codesignal.com/learn/courses/cluster-performance-unveiled/lessons/mastering-the-davies-bouldin-index-for-clustering-model-validation)​  
...
3. **Calinski-Harabasz Index (Variance Ratio):**[wikipedia+1](https://en.wikipedia.org/wiki/Calinski%E2%80%93Harabasz_index)​  
...
##### Deep Embedded Clustering (DEC)[pmc.ncbi.nlm.nih+1](https://pmc.ncbi.nlm.nih.gov/articles/PMC12575845/)​
...
##### Contrastive Clustering (SwAV, SCAN)youtube​[github](https://github.com/Wolfda95/SSL-MedicalImagining-CL-MAE)​
...
##### TabNet[innopolis](https://innopolis.university/filespublic/Artem%20Babenko.%20Tabular%20Deep%20Learning.pdf)​
...
#### PCA vs t-SNE vs UMAP[mbrenndoerfer+2](https://mbrenndoerfer.com/writing/tsne-dimensionality-reduction-visualization)​
